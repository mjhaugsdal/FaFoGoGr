...
# Flips the value from 0 / 1 or reverse
#
...
# Used to evaluate if state is legal or not.
...
# Generates the tree of possible moves recursively
# Input: x(current state), par(shows the parent, removes redundant moves)
# Output: Void
def make_tree(x, par):
...
# Creates the root of the tree, first state.
def create_root():
